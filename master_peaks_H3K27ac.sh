#!/bin/bash
# original author : Bob Thurman
# version author : Paddy Harker

beds=*_q0.05_broad_peaks.broadPeak

out=GSC_H3K27AC_Master_peaks.broadPeak
...
## final solution
bedops -u $solns | awk -v OFS='\t' '{$5=int($5);print $0}' > $out
